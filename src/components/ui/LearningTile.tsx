...
export function LearningTile({
  ...
  return (
    <button
      ...
      className="flex min-h-24 flex-col items-center justify-center gap-1 rounded-2xl bg-white p-3 shadow-card transition-all duration-150 active:scale-95 sm:min-h-28"
      style={
        selected
